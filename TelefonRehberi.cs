...
List<Kisi> Rehber= new List<Kisi>();
           Rehber.Add(new Kisi("Melih Ömer","Kamar","551 555 55 55"));
           Rehber.Add(new Kisi("Arda","Deniz","552 555 55 55"));
           Rehber.Add(new Kisi("Zikriye","Ürkmez","553 555 55 55"));
           Rehber.Add(new Kisi("Ayşe","Kara","554 555 55 55"));
           Rehber.Add(new Kisi("Aslı", "Çakır","555 555 55 55"));
